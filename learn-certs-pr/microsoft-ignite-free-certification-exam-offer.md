...
3. Accedi con l'account Microsoft associato al tuo profilo di Microsoft Certification.  Se non hai un profilo di Microsoft Certification, dovrai crearne uno.
4. Dopo aver effettuato l'accesso con il tuo profilo di Microsoft Certification, verifica che i dati del tuo profilo siano corretti.
...
7. Per verificare il tuo account, devi eseguire l'autenticazione usando lo stesso account social che hai usato per registrarti all'evento (NOTA: Se hai usato un account Microsoft per registrarti all'evento, dovrai usare questo account Microsoft per accedere al tuo profilo di certificazione e programmare la partecipazione all'esame. Se scopri di avere due profili di certificazione, contatta i [Forum di supporto per le Microsoft Certification](https://trainingsupport.microsoft.com/It-it/mcp/forum?sort=LastReplyDate&dir=Desc&tab=All&status=all&mod=&modAge=&advFil=&postedAfter=&postedBefore=&threadType=All&isFilterExpanded=false&page=1) per unire i tuoi profili dopo che avrai sostenuto l'esame di certificazione.
8. Segui la procedura descritta nelle seguenti schermate e inserisci i dati richiesti per programmare l'esame.
9. Nella pagina del pagamento, verifica che il totale sia pari a $ 0,00 e invia l'ordine.  Nota: Nella pagina 'My order' (Il mio ordine) deve essere visibile il seguente sconto in fondo alla pagina:  ***Microsoft Ignite 2019-2020 - Sconto del 100%***.  Puoi vedere il prezzo non scontato nel flusso di programmazione degli esami alle pagine precedenti.

***Supporto per le certificazioni:***

Se hai problemi con la programmazione dell'esame, puoi richiedere assistenza ai [forum di supporto per le Microsoft Certification](https://trainingsupport.microsoft.com/It-it/mcp/forum?sort=LastReplyDate&dir=Desc&tab=All&status=all&mod=&modAge=&advFil=&postedAfter=&postedBefore=&threadType=All&isFilterExpanded=false&page=1). Il moderatore del forum ti risponderà entro un giorno lavorativo.
...
- Quest'offerta per sostenere gratuitamente l'esame viene offerta solo a persone che si sono registrate e hanno partecipato a un evento Microsoft Ignite 2019 o Microsoft Ignite The Tour 2019-2020 ufficiale.
...
## FAQ - Offerta di esami gratuiti presso MS Ignite e The Tour
