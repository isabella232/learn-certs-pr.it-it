...
Se hai dubbi sull’accuratezza tecnica di un particolare argomento, segui la procedura [Opposizione a un elemento dell’esame](/learn/certifications/exam-item-challenge-process).
...
Poiché Microsoft introduce continuamente tecnologie di test e tipi di domande innovativi, non forniamo questo tipo di informazioni per ogni esame. Per avere un'idea dei contenuti che è possibile trovare in un esame, consigliamo di consultare alcuni [formati di esami e tipi di domade](/learn/certifications/certification-exams#exam-formats-and-question-types).
...
**Cosa si intende per "discariche cerebrali," e sono legali?**
