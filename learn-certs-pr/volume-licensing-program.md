...
* Microsoft Imagine Academy (per le organizzazioni idonee)
  ...
  * Risorse di marketing, utili per promuovere l’associazione con il marchio Microsoft e le sue certificazioni ufficiali
  ...
  Il programma di formazione per studenti universitari e studenti in cerca di una formazione professionale è accessibile a tutti gli istituti accademici dietro pagamento di un abbonamento. Per aderire al [programma Microsoft Imagine Academy](https://www.microsoft.com/it-it/education/imagine-academy/default.aspx), è necessario mantenere determinati [standard e requisiti](https://www.microsoft.com/it-it/education/imagine-academy/become-a-member/default.aspx).

* Pacchetti di esami di certificazione Microsoft per istituti accademici
